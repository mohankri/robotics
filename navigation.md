...
Execute movement while avoiding obstacles (Robot Control & Obstacle Avoidance) – It sends commands to its wheels (or other actuators) to follow the planned path while detecting and avoiding obstacles in real time.
